...
bg-gradient-to-tr from-cyan-500 via-cyan-600 to-teal-600
<div
  className="relative overflow-hidden w-full h-80 rounded-3xl cursor-pointer text-2xl font-bold bg-neutral-50 rounded-xl bg-gradient-to-tr from-cyan-500 via-cyan-600 to-teal-600"
>
  <div className="z-10 absolute w-full h-full peer"></div>
  <div
    className="absolute peer-hover:-top-20 peer-hover:-left-16 peer-hover:w-[140%] peer-hover:h-[140%] -top-33 -left-20 w-32 h-44 rounded-full bg-emerald-500 transition-all duration-500"
  ></div>
  <div
    className="absolute flex text-xl text-center items-end justify-end peer-hover:right-0 peer-hover:rounded-b-none peer-hover:bottom-0 peer-hover:items-center peer-hover:justify-center peer-hover:w-full peer-hover:h-full -bottom-32 -right-16 w-36 h-44 rounded-full bg-emerald-500 transition-all duration-500"
  >
      <div className="stats bg-transparent shadow-none mt-2 w-full">
        <div className="grid grid-cols-1 w-full">

          {/* --- Nombre de tutos --- */}
          <div className="stat place-items-center p-2 text-stone-700 stat-title text-xs">
            <div className="text-stone-700 stat-title text-xs">Tutos</div>
