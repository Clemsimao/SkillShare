...
export default async function ProfilePage( { params }: PageProps) {
    ...
    const user = {
        ...
        about:
            "Artiste et formateur passionné par l’illustration et la photo. Je peux vous aider à apprendre les bases de la photographie et de rendre jolis vos souvenirs les plus inoubliables. La photo c'est la vie",
